...
(
    ...
    localparam PAD9 = log2ceil(64'ha0010 - 64'ha0000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'ha0010;
    ...
    // ( 0x30000 .. 0x30010 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 20'h30000   ) begin
    ...
    // ( 0x50000 .. 0x50010 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 20'h50000   ) begin
    ...
    // ( 0x70000 .. 0x70010 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 20'h70000   ) begin
